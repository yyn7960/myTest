...
FCKConfig.ToolbarSets["Skoda"] = [
	['Bold','Italic','Underline','StrikeThrough','TextColor','BGColor','-','JustifyLeft','JustifyCenter','JustifyRight','JustifyFull','-','Undo','Redo','-','Link','Unlink','Image','Table'],
	'/',
	['Style','FontFormat','FontName','FontSize']
] ;
FCKConfig.ToolbarSets["Skoda1"] = [
	['Image']
] ;
